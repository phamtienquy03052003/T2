...
const Register: React.FC<RegisterProps> = ({ onClose, onSwitchToLogin, onRegisterSuccess }) => {
        ...
        <div className="px-6 py-6">
          ...
          <div onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Choose a unique username. This name will be visible to other users.
              </p>
            </div>
            ...
            <p className="text-xs text-gray-500">
              At least 8 characters. For your security, don't reuse passwords from other sites.
            </p>

            {/* Captcha placeholder */}
            <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              <p className="text-sm text-gray-600">CAPTCHA verification would appear here</p>
            </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-500">
              ...
              <button className="text-blue-500 hover:underline">Terms of Service</button> and{' '}
              <button className="text-blue-500 hover:underline">Privacy Policy</button>, including{' '}
              <button className="text-blue-500 hover:underline">Cookie Use</button>.
            </p>
          </div>
        </div>
      </div>
